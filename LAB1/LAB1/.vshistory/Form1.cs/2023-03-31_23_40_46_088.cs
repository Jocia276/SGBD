...
namespace LAB1
{
    public partial class Form1 : Form
    {
        ...
        private void dataGridViewProdus_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {

        }

        private void car_denum_TextChanged(object sender, EventArgs e)
        {
