                        ...
                        using (SqlTransaction transaction = connection.BeginTransaction())
                        {
                            try
                            {
                                using (SqlCommand command = connection.CreateCommand())
                                {
                                    ...
                                    // Update statement 1
                                    command.CommandText = "UPDATE Produs SET denumire = 'Transaction 2' WHERE id_produs = 73";
                                    ...
                                    // Update statement 2
                                    command.CommandText = "UPDATE Producator SET nume = 'Transaction 2' WHERE id_producator = 1";
                                    command.ExecuteNonQuery();
                                }
                        ...
                        using (SqlTransaction transaction = connection.BeginTransaction())
                        {
                            try
                            {
                                using (SqlCommand command = connection.CreateCommand())
                                {
                                    ...
                                    // Update statement 1
                                    command.CommandText = "UPDATE Producator SET nume = 'Transaction 1' WHERE id_producator = 1";
                                    command.ExecuteNonQuery();
                                    ...
                                    // Update statement 2
                                    command.CommandText = "UPDATE Produs SET denumire = 'Transaction 1' WHERE id_produs = 73";
                                    command.ExecuteNonQuery();
                                }
