...
namespace LAB1
{
    public partial class Form1 : Form
    {
        ...
        private void add_prod_Click(object sender, EventArgs e)
        {
            ...
            da.InsertCommand.Parameters.Add("@id", SqlDbType.Int).Value = dsP.Tables[dataGridViewCategorie.CurrentCell.ColumnIndex].Rows[dataGridViewCategorie.CurrentCell.RowIndex][0];
