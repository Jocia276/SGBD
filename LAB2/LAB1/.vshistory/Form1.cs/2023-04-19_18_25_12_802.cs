...
namespace LAB1
{
    public partial class Form1 : Form
    {
        ...
        private void delete_prod_Click(object sender, EventArgs e)
        {
            ...
            da.DeleteCommand.Parameters.Add("@id", SqlDbType.Int).Value = dsC.Tables[0].Rows[dataGridViewProdus.CurrentCell.RowIndex][0];
        ...
        {
            da.InsertCommand = new SqlCommand(insertQuerry, cs);
            da.InsertCommand.Parameters.Add("@id_cat", SqlDbType.Int).Value = dsP.Tables[dataGridViewCategorie.CurrentCell.ColumnIndex].Rows[dataGridViewCategorie.CurrentCell.RowIndex][0];
