    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    parentAdapter.SelectCommand = new SqlCommand("SELECT * FROM Briose", conn);
                    pds.Clear(); cds.Clear();
        ...
        private void dataGridViewParent_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            using (SqlConnection conn = new SqlConnection(connectionString))
            {
                ...
                childAdapter.SelectCommand = new SqlCommand("SELECT *FROM Cofetarii where cod_cofetarie=" + id + ";", conn);
                childds.Clear();
