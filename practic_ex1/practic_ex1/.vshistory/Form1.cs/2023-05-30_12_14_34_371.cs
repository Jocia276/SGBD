        ...
        private void buttonAdd_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    childAdapter.UpdateCommand.Parameters.Add("@nb", SqlDbType.VarChar).Value = textBox5.Text;
                    childAdapter.UpdateCommand.Parameters.Add("@d", SqlDbType.VarChar).Value = textBox6.Text;
                    childAdapter.UpdateCommand.Parameters.Add("@p", SqlDbType.Real).Value = textBox7.Text;
